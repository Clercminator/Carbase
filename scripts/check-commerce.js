...
console.log(JSON.stringify({paymentsEnabled:env.COMMERCE_ENABLED==='true',subscriptionsEnabled:env.SUBSCRIPTIONS_ENABLED==='true',missingVariables:required.filter(k=>!env[k])}))
...
for(const table of ['commerce_orders','commerce_reports','commerce_redemptions','commerce_subscriptions']){
